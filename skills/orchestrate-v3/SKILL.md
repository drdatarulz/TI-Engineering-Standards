...
### Observability
| Ticket | Refine Tokens | Impl Tokens | Review Tokens | Security Tokens | Test Tokens | Total Tokens | Duration |
|--------|--------------|-------------|---------------|-----------------|-------------|-------------|----------|
| AZ-XXX | 12,400 | 45,230 | 18,100 | 9,800 | 22,400 | 107,930 | 95s |
...
<!-- pipeline: v3-pr-based-milestones -->
